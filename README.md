...
2. 用配套工具导入 [examples/NT26/started/hello](examples/NT26/started/hello)，确认能烧录、能看日志。
3. 再跑 `started/log`、`started/task`，熟悉日志和协作式任务。
4. 需要哪块能力，打开 [API 索引](docs/NT26/api/README.md) 对应模块，并对照同页给出的示例目录。
